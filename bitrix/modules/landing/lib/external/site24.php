...
class Site24
{
    ...
    {
        return self::Execute("update", array("domain" => $domain, "newname" => $newName));
    }
    ...
    {
        return self::Execute("add", array("domain" => $domain, "url" => $url, "active" => $active));
    }
    ...
    {
        return self::Execute("addrandom", array('url' => $url));
    }
