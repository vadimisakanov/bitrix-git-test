...
return array(
	...
	'fields' => array(
		'ADDITIONAL_FIELDS' => array(
			...
			'METAOG_IMAGE' => 'https://repo.bitrix24.site/bitrix/images/demo/page/wedding/preview.jpg',
				...
				<div class="col-md-4">
					...
					<div class="landing-block-node-card-contact">
						<div class="media align-items-center mb-4">
							...
							<div class="media-body">
								<div class="g-font-size-12 g-font-open-sans mb-0" data-form-style-main-font-weight="1" data-form-style-header-text-font-size="1" data-form-style-label-font-weight="1" data-form-style-label-font-size="1" data-form-style-second-font-color="1"><a href="tel:+32(0)333444555" class="landing-block-node-contact-link g-color-white ">
										+32 (0) 333 444 555</a>
								</div>
							</div>
						</div>
					...
					<div class="landing-block-node-card-contact">
						<div class="media align-items-center mb-4">
							...
							<div class="media-body">
								<div class="g-font-size-12 g-font-open-sans mb-0" data-form-style-main-font-weight="1" data-form-style-header-text-font-size="1" data-form-style-label-font-weight="1" data-form-style-label-font-size="1" data-form-style-second-font-color="1"><a href="tel:+32(0)333444666" class="landing-block-node-contact-link g-color-white ">
										+32 (0) 333 444 666</a>
								</div>
							</div>
						</div>
					...
					<div class="landing-block-node-card-contact">
						<div class="media align-items-center mb-4">
							...
							<div class="media-body">
								<div class="g-font-size-12 g-font-open-sans mb-0" data-form-style-main-font-weight="1" data-form-style-header-text-font-size="1" data-form-style-label-font-weight="1" data-form-style-label-font-size="1" data-form-style-second-font-color="1"><a href="tel:+32(0)333444777" class="landing-block-node-contact-link g-color-white">
										+32 (0) 333 444 777</a>
								</div>
							</div>
						</div>
					...
					<div class="landing-block-node-card-contact">
						<div class="media align-items-center g-mb-60">
							...
							<div class="media-body">
								<div class="g-font-size-12 g-font-open-sans mb-0" data-form-style-main-font-weight="1" data-form-style-header-text-font-size="1" data-form-style-label-font-weight="1" data-form-style-label-font-size="1" data-form-style-second-font-color="1"><a href="mailto:info@company24.com" class="landing-block-node-contact-link g-color-white">info@company24.com</a>
								</div>
							</div>
						</div>
					</div>
