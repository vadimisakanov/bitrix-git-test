...
return array(
	'active' => \Bitrix\Main\Config\Option::get('landing', 'b24partner', 'N') == 'Y',
	...
	'fields' => array(
		'ADDITIONAL_FIELDS' => array(
			...
			'METAOG_IMAGE' => 'https://repo.bitrix24.site/bitrix/images/demo/page/bitrix24/preview.jpg',
...
<header class="landing-block landing-block-menu u-header u-header--sticky-top u-header--change-appearance" data-header-fix-moment="100">
                    ...
                    <div class="landing-block-card-container g-pos-rel g-parent g-theme-business-bg-blue-dark-v2 g-py-35 g-px-25 g-pl-70--sm">
                        <div class="g-hidden-xs-down g-absolute-centered--y g-left-0 g-absolute-top-px">
                            <div class="g-pull-50x-left g-brd-around g-brd-5 g-brd-primary-dark-v3 g-rounded-50x g-overflow-hidden">
                                <span class="landing-block-node-element-icon-hover d-block g-pos-abs g-top-0 g-left-0 g-width-95 g-height-95 g-brd-around g-brd-5 g-brd-primary g-rounded-50x" style="background-image: url(\'https://cdn.bitrix24.ru/b1479079/landing/35f/35f9fe44e89822cc1583f2fafad524f7/help-cloudman-07.jpg\');" data-fileid="5498" data-filehash="69c421b0d54123b9bf68019eedd461be"></span>
		...
		<div class="container g-pos-rel g-z-index-1">
			<div class="row align-items-center">
				...
				<div class="col-md-8 g-mb-50">
					<div class="bitrix24forms g-brd-around g-brd-white-opacity-0_6 g-px-45 g-py-60" data-b24form="" data-form-style-input-border-color="1" data-b24form-use-style="Y" data-b24form-show-header="N" data-b24form-original-domain=""></div>
				</div>
				...
				<div class="col-md-4 g-mb-50">
					...
					<div class="landing-block-node-card-contact">
						<div class="media align-items-center mb-4">
							...
							<div class="media-body">
								<div class="landing-block-node-contact-text g-color-white-opacity-0_6 mb-0" data-form-style-main-font-weight="1" data-form-style-header-text-font-size="1" data-form-style-label-font-weight="1" data-form-style-label-font-size="1" data-form-style-second-font-color="1">+7 (495) 000 00 00</div>
							</div>
						</div>
					</div>
					<!-- End Icon Block -->
					...
					<div class="landing-block-node-card-contact">
						<div class="media align-items-center mb-4">
							...
							<div class="media-body">
								...
								>
									<a href="tel:+7 (495) 000 00 01" class="landing-block-node-contact-link g-color-white-opacity-0_6">+7 (495) 000 00 01</a>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="media align-items-center mb-4">
							...
							<div class="media-body">
								<div class="landing-block-node-contact-text g-color-white-opacity-0_6 mb-0"
									 ...
									 data-form-style-label-font-size="1"
									 data-form-style-second-font-color="1"
								><a href="tel:+7 (495) 000 00 02" class="landing-block-node-contact-link g-color-white-opacity-0_6">+7 (495) 000 00 02</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="landing-block-node-card-contact">
						<div class="media align-items-center g-mb-60">
							...
							<div class="media-body">
								<div class="landing-block-node-contact-text g-color-white-opacity-0_6 mb-0" data-form-style-main-font-weight="1" data-form-style-header-text-font-size="1" data-form-style-label-font-weight="1" data-form-style-label-font-size="1" data-form-style-second-font-color="1">contact<a href="mailto:info@company24.com">@company24.</a>ru</div>
							</div>
						</div>
					</div>
					<!-- End Icon Block -->
