...
return array(
	...
	'fields' => array(
		'ADDITIONAL_FIELDS' => array(
		    'METAOG_IMAGE' => 'https://repo.bitrix24.site/bitrix/images/demo/page/holidays/holiday.8march2/preview.jpg',
		...
		<nav class="navbar navbar-expand-lg g-py-0">
			<div class="container">
				...
				<a href="#" class="navbar-brand landing-block-node-menu-logo-link u-header__logo" target="_self">
					<img class="landing-block-node-menu-logo u-header__logo-img u-header__logo-img--main g-max-width-180" src="/bitrix/images/landing/logos/wedding-logo.png" alt="" />
				</a>
				<!-- End Logo -->
				...
				<div class="col-md-4">
					...
					<div class="landing-block-node-card-contact">
						<div class="media align-items-center mb-4">
							...
							<div class="media-body">
								<div class="landing-block-node-contact-text mb-0 g-color-white g-font-size-12 g-font-open-sans" data-form-style-main-font-weight="1" data-form-style-header-text-font-size="1" data-form-style-label-font-weight="1" data-form-style-label-font-size="1" data-form-style-second-font-color="1">5B Streat, City 50987 New Town US</div>
							</div>
						</div>
					</div>
					<!-- End Icon Block -->
					...
					<div class="landing-block-node-card-contact">
						<div class="media align-items-center mb-4">
							...
							<div class="media-body">
							<div class="mb-0 g-color-white g-font-size-12 g-font-open-sans" data-form-style-main-font-weight="1" data-form-style-header-text-font-size="1" data-form-style-label-font-weight="1" data-form-style-label-font-size="1" data-form-style-second-font-color="1"><a href="tel:+32(0)333444555" class="landing-block-node-contact-link g-color-white">
									+32 (0) 333 444 555</a>
							</div>
							</div>
						</div>
					...
					<div class="landing-block-node-card-contact">
						<div class="media align-items-center mb-4">
							...
							<div class="media-body">
								<div class="mb-0 g-color-white g-font-size-12 g-font-open-sans" data-form-style-main-font-weight="1" data-form-style-header-text-font-size="1" data-form-style-label-font-weight="1" data-form-style-label-font-size="1" data-form-style-second-font-color="1"><a href="tel:+32(0)333444666" class="landing-block-node-contact-link g-color-white">
										+32 (0) 333 444 666</a>
								</div>
							</div>
						</div>
					</div><div class="landing-block-node-card-contact">
						<div class="media align-items-center mb-4">
							<div class="d-flex">
								<span class="u-icon-v1 u-icon-size--sm g-color-white mr-2">
								  <i class="landing-block-card-contact-icon icon-communication-033 u-line-icon-pro"></i>
							...
							<div class="media-body">
								<div class="mb-0 g-color-white g-font-size-12 g-font-open-sans" data-form-style-main-font-weight="1" data-form-style-header-text-font-size="1" data-form-style-label-font-weight="1" data-form-style-label-font-size="1" data-form-style-second-font-color="1"><a href="tel:+32(0)333444777" class="landing-block-node-contact-link g-color-white">
										+32 (0) 333 444 777</a>
								</div>
							</div>
						</div>
						...
						<div class="media align-items-center g-mb-60">
							...
							<div class="media-body">
								<div class="g-color-white mb-0 g-font-size-12 g-font-open-sans" data-form-style-main-font-weight="1" data-form-style-header-text-font-size="1" data-form-style-label-font-weight="1" data-form-style-label-font-size="1" data-form-style-second-font-color="1"><a href="mailto:info@company24.com" class="landing-block-node-contact-link g-color-white">info@company24.com</a>
								</div>
							</div>
						</div>
					</div>
