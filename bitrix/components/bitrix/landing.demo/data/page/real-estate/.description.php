...
return array(
	...
	'fields' => array(
		'ADDITIONAL_FIELDS' => array(
			...
			'METAOG_IMAGE' => 'https://repo.bitrix24.site/bitrix/images/demo/page/real-estate/preview.jpg',
					...
					<div class="row">
						<div class="landing-block-card-menu-contact col-sm g-brd-right--sm g-brd-gray-light-v4">
							<div class="g-pa-10--lg">
								...
								<div class="landing-block-node-menu-contact-title d-inline-block text-uppercase g-font-size-13">Call Us</div>
								<strong class="landing-block-node-menu-contact-value d-block g-pl-25">+469 548
									521</strong>
							</div>
						</div>
						...
						<div class="landing-block-card-menu-contact col-sm g-hidden-md-down g-brd-right--sm g-brd-gray-light-v4">
							<div class="g-pa-10--lg">
								...
								<div class="landing-block-node-menu-contact-title d-inline-block text-uppercase g-font-size-13">Opening time</div>
								<strong class="landing-block-node-menu-contact-value d-block g-pl-25">Mon-Sat: 08.00 -
									18.00</strong>
							</div>
						</div>
						...
						<div class="landing-block-card-menu-contact col-sm g-hidden-sm-down g-brd-right--sm g-brd-gray-light-v4">
							<div class="g-pa-10--lg">
								...
								<div class="landing-block-node-menu-contact-title d-inline-block text-uppercase g-font-size-13">Email us</div>
				...
				<div class="collapse navbar-collapse align-items-center flex-sm-row g-mr-40--sm" id="navBar">
					<ul class="landing-block-node-menu-list js-scroll-nav navbar-nav text-uppercase g-font-weight-700 g-font-size-13 g-py-10--md mr-auto">
						...
						<li class="landing-block-node-menu-list-item nav-item g-mx-15--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[04.7.one_col_fix_with_title_and_text_2]" class="landing-block-node-menu-list-item-link nav-link g-color-primary--hover p-0" target="_self">FLATS FOR RENT</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-15--lg g-mb-7 g-mb-0--lg">
						...
						<li class="landing-block-node-menu-list-item nav-item g-ml-15--lg">
							<a href="#block@block[33.3.form_1_transparent_black_no_text]" class="landing-block-node-menu-list-item-link nav-link g-color-primary--hover p-0" target="_self">CONTACT</a>
						</li>
					</ul>
				</div>
				<!-- End Navigation -->
	...
	<div class="js-carousel carouselVertical002 g-overflow-hidden" data-autoplay="true" data-infinite="true" data-speed="10000" data-vertical="true" data-pagi-classes="u-carousel-indicators-v7 text-center g-ml-30">
        ...
        <div class="container landing-block-node-subcontainer text-center g-max-width-800 g-mb-20">
            ...
            <div class="landing-block-node-inner text-uppercase u-heading-v2-4--bottom g-brd-primary">
                ...
                <h2 class="landing-block-node-title u-heading-v2__title g-line-height-1_1 g-font-weight-700 g-font-size-40 g-color-black g-mb-minus-10">POPULAR FLATS FOR RENT</h2>
            </div>
	...
	<div class="container">
		...
		'35.2.footer_dark' =>
			array (
				...
				'SORT' => '8000',
				'CONTENT' => '<section class="g-color-gray-light-v1 g-py-60 g-theme-architecture-bg-blue-dark-v1">
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-12 col-md-2 col-lg-2">
				<h2 class="landing-block-node-title text-uppercase g-color-white g-font-weight-700 g-font-size-16 g-mb-20">USEFUL Link</h2>
				<ul class="list-unstyled g-mb-30">
					<li class="landing-block-card-list-item g-mb-10">
						<a class="landing-block-node-list-item g-color-gray-light-v2" href="#">Pellentesque a tristique
							risus</a>
